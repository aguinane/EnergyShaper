...
MONTH_RECORDS = [
    ...
    (datetime.datetime(2017, 2, 1, 0, 0), datetime.datetime(2017, 2, 9, 0, 0), 5*8),
...
def main():
    ...
    print('\n\n')
    print('Re-grouping output')
    hourly2 = list(group_into_profiled_intervals(hourly, interval_m=60,
                                                 profile=[1, 1, 1, 1]))
    for row in hourly2[0:5]:
        print(row)
    print('...')
    for row in hourly2[-5:]:
        print(row)
